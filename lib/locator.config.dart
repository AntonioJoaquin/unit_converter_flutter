...
import 'view/src/pages/converter/longitude/longitude_controller_listeners.dart'
    as _i24;
import 'view/src/pages/converter/longitude/longitude_converter.dart' as _i63;
import 'view/src/pages/converter/longitude/longitude_tab_manager.dart' as _i64;
import 'view/src/pages/converter/mass/mass_controller_listeners.dart' as _i25;
import 'view/src/pages/converter/mass/mass_converter.dart' as _i65;
import 'view/src/pages/converter/mass/mass_tab_manager.dart' as _i66;
import 'view/src/pages/converter/money/money_controller_listeners.dart' as _i37;
import 'view/src/pages/converter/money/money_converter.dart' as _i67;
import 'view/src/pages/converter/money/money_tab_manager.dart' as _i68;
...
import 'view/src/pages/converter/temperature/temperature_tab_manager.dart'
    as _i53;
import 'view/src/pages/converter/time/time_controller_listeners.dart' as _i54;
import 'view/src/pages/converter/time/time_converter.dart' as _i69;
import 'view/src/pages/converter/time/time_tab_manager.dart' as _i70;
import 'view/src/pages/converter/velocity/velocity_controller_listeners.dart'
    as _i56;
import 'view/src/pages/converter/velocity/velocity_converter.dart' as _i57;
import 'view/src/pages/converter/velocity/velocity_tab_manager.dart' as _i58;
import 'view/src/pages/home/home_manager.dart' as _i15;
import 'view/src/pages/splash/splash_manager.dart' as _i49;
...
import 'view/src/utils/converters/longitude/nautical_mile_unit_converter.dart'
    as _i41;
import 'view/src/utils/converters/longitude/yard_unit_converter.dart' as _i60;
...
import 'view/src/utils/converters/mass/stone_unit_converter.dart' as _i50;
import 'view/src/utils/converters/mass/ton_unit_converter.dart' as _i55;
...
import 'view/src/utils/converters/money/yen_unit_converter.dart' as _i62;
...
import 'view/src/utils/converters/time/week_unit_converter.dart' as _i59;
import 'view/src/utils/converters/time/year_unit_converter.dart' as _i61;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i49.SplashManager>(() => _i49.SplashManager());
  gh.lazySingleton<_i50.StoneUnitConverter>(() => _i50.StoneUnitConverter());
  gh.factory<_i51.TemperatureControllerListeners>(
      () => _i51.TemperatureControllerListeners());
  gh.lazySingleton<_i52.TemperatureConverter>(() => _i52.TemperatureConverter(
        get<_i3.CelsiusUnitConverter>(),
        get<_i11.FahrenheitUnitConverter>(),
        get<_i18.KelvinUnitConverter>(),
      ));
  gh.factory<_i53.TemperatureTabManager>(() => _i53.TemperatureTabManager(
        get<_i51.TemperatureControllerListeners>(),
        get<_i52.TemperatureConverter>(),
      ));
  gh.factory<_i54.TimeControllerListeners>(
      () => _i54.TimeControllerListeners());
  gh.lazySingleton<_i55.TonUnitConverter>(() => _i55.TonUnitConverter());
  gh.factory<_i56.VelocityControllerListeners>(
      () => _i56.VelocityControllerListeners());
  gh.lazySingleton<_i57.VelocityConverter>(() => _i57.VelocityConverter(
  ...
  gh.factory<_i58.VelocityTabManager>(() => _i58.VelocityTabManager(
        get<_i56.VelocityControllerListeners>(),
        get<_i57.VelocityConverter>(),
      ));
  gh.lazySingleton<_i59.WeekUnitConverter>(() => _i59.WeekUnitConverter());
  gh.lazySingleton<_i60.YardUnitConverter>(() => _i60.YardUnitConverter());
  gh.lazySingleton<_i61.YearUnitConverter>(() => _i61.YearUnitConverter());
  gh.lazySingleton<_i62.YenUnitConverter>(() => _i62.YenUnitConverter());
  gh.lazySingleton<_i63.LongitudeConverter>(() => _i63.LongitudeConverter(
        ...
        get<_i60.YardUnitConverter>(),
        get<_i13.FootUnitConverter>(),
        get<_i17.InchUnitConverter>(),
        get<_i41.NauticalMileUnitConverter>(),
      ));
  gh.factory<_i64.LongitudeTabManager>(() => _i64.LongitudeTabManager(
        get<_i24.LongitudeControllerListeners>(),
        get<_i63.LongitudeConverter>(),
      ));
  gh.lazySingleton<_i65.MassConverter>(() => _i65.MassConverter(
        get<_i55.TonUnitConverter>(),
        ...
        get<_i50.StoneUnitConverter>(),
        get<_i46.PoundUnitConverter>(),
        get<_i44.OunceUnitConverter>(),
      ));
  gh.factory<_i66.MassTabManager>(() => _i66.MassTabManager(
        get<_i25.MassControllerListeners>(),
        get<_i65.MassConverter>(),
      ));
  gh.lazySingleton<_i67.MoneyConverter>(() => _i67.MoneyConverter(
        get<_i10.EuroUnitConverter>(),
        get<_i45.PesetaUnitConverter>(),
        get<_i9.DollarUnitConverter>(),
        get<_i62.YenUnitConverter>(),
      ));
  gh.factory<_i68.MoneyTabManager>(() => _i68.MoneyTabManager(
        get<_i37.MoneyControllerListeners>(),
        get<_i67.MoneyConverter>(),
      ));
  gh.lazySingleton<_i69.TimeConverter>(() => _i69.TimeConverter(
        get<_i5.CenturyUnitConverter>(),
        get<_i8.DecadeUnitConverter>(),
        get<_i61.YearUnitConverter>(),
        get<_i38.MonthUnitConverter>(),
        get<_i59.WeekUnitConverter>(),
  ...
  gh.factory<_i70.TimeTabManager>(() => _i70.TimeTabManager(
        get<_i54.TimeControllerListeners>(),
        get<_i69.TimeConverter>(),
      ));
  return get;
}
